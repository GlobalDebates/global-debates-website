      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            Fostering Leadership through Global Debates
            </h1>
            ...
            <div className="flex flex-col items-start py-5 space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                href="#"
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-white bg-[#0b82c5] rounded-full ">
                Get involved
              </a>
              {/* <a
                href="#"
                ...
                <span> Get the format for free</span>
              </a> */}
            </div>
          </div>
        </div>
